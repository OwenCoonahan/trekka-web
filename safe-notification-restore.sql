-- Safely restore notification triggers (handles existing triggers)

-- Drop and recreate follow notification trigger
...
-- Update existing trip notification trigger to fix column references
